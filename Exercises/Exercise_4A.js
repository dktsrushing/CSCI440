...
var lowerRotate = false;
var lowerArmFlag = false;
var upperRotate = false;
var upperArmFlag = false;
...
window.onload = function init() {
    ...
    document.getElementById("Button1").onclick = function(){
        lowerRotate = !lowerRotate;
    };
    document.getElementById("Button2").onclick = function(){
        upperRotate = !upperRotate;
    };
...
var render = function() {
    ...
    if (lowerRotate == true && lowerArmFlag == false){
        theta[LowerArm] += 0.5;
        if (theta[LowerArm] >= 45){
            lowerArmFlag = true;
        }
    }
    else if (lowerRotate == true && lowerArmFlag == true){
        theta[LowerArm] -= 0.5;
        if (theta[LowerArm] <= -45){
            lowerArmFlag = false;
        }
    ...
    if (upperRotate == true && upperArmFlag == false){
        theta[UpperArm] += 0.5;
        if (theta[UpperArm] >= 90){
            upperArmFlag = true;
        }
    }
    else if (upperRotate == true && upperArmFlag == true){
        theta[UpperArm] -= 0.5;
        if (theta[UpperArm] <= -90){
            upperArmFlag = false;
        }
...
/*
Make button toggling rotation of base
Make button waving lower arm (45 to -45 degrees)
Make button waving upper arm (90 to -90 degrees)
*/