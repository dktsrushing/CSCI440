...
//printm(m);
    ...
    positionsArray.push(vec4(-0.8, 0.5,  -0.5, 1.0));
    positionsArray.push(vec4(-0.8,  0.5,  0.5, 1.0));
    ...
    document.getElementById("Button11").onclick = function(){lightMove += 0.25;};
    document.getElementById("Button12").onclick = function(){lightMove -= 0.25;};
